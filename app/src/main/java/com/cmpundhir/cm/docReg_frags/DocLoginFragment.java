...
public class DocLoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_doc_login, container, false);
        cantLog=view.findViewById(R.id.docFrag_contLog_btn);
