...
public class PatientRegActivity extends AppCompatActivity implements OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateProgressBar.setOnStateItemClickListener(new OnStateItemClickListener() {
            ...
            public void onStateItemClick(StateProgressBar stateProgressBar, StateItem stateItem, int stateNumber, boolean isCurrentState) {
                Toast.makeText(getApplicationContext(), "You Select :  " +stateNumber+ data, Toast.LENGTH_LONG).show();

            }
        });

        getSupportFragmentManager().beginTransaction().replace(R.id.container,new PatRegFragment()).commit();
//
//        ButterKnife.bind(this);
//        mAuth = FirebaseAuth.getInstance();
//        regBtn = findViewById(R.id.patReg_btn);
//
//        progressbar = findViewById(R.id.progressbarPati);
...
//        startActivity(new Intent(PatientRegActivity.this, LoginChoiceActivity.class));
//
//    }
...
//                break;
            ...
            case R.id.ok_formPat :
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.container,new PatLoginFragment()).commit();
                break;
